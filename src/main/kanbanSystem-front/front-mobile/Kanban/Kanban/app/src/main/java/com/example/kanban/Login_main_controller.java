...
public class Login_main_controller extends AppCompatActivity {
    ...
    private void showError() {
        Toast.makeText(Login_main_controller.this, "Erreur de connexion. Veuillez réessayer.", Toast.LENGTH_SHORT).show();
    }
}
